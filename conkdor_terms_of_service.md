...
This Terms of Service Agreement (the "Agreement") is entered into between Lucas (@sillygooooose) ("Bot Owner") and the user ("User") of the Conkdor Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of [Your country/state/province]. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of an arbritation provider of the Bot Owner's choice.
